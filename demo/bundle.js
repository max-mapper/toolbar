...
require.define("/js/toolbar/demo/demo.js",function(require,module,exports,__dirname,__filename,process,global){var toolbar = require('toolbar')
toolbar('.bar-tab').on('select', function(selected) {
  console.log(selected)
})

});
require("/js/toolbar/demo/demo.js");
})();
